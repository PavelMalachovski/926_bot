...
Всё остальное **идентично** в обоих профилях: сессии 08–20 Прага, min RR 1:2,
...
```mermaid
flowchart TD
    A([M5 свеча закрылась]) --> R0{"Rule 0.1<br/>Сессия 08–20 Прага?<br/>форекс Пн–Пт"}
...
### Rule 0.1 — Сессия
Входы только в торговом окне **08:00–20:00 Прага**, разбитом на два блока:
Frankfurt/London (08–14) и New York (14–20). Крипта каждый день, форекс —
...
цена сидела в зоне; исправлено в обоих профилях). От этого начала `find_choch`
